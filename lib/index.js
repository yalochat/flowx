...
const catboxOptions = {
  uri: process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/?maxPoolSize=5', // Defaults to 'mongodb://127.0.0.1:27017/?maxPoolSize=5'
  partition: process.env.MONGODB_DB || 'flowxdb'
}

const client = Promise.promisifyAll(new Catbox.Client(CatboxMongodb, catboxOptions))
